  ...
  return (
    ...
    <section className='webdev1'>
     ...
     data-aos-anchor-placement="center-center" data-aos-duration="1000">
                <h2>UI UX Design Service Company</h2>
                <h4>We design intuitive, engaging & user-friendly to create an amazing digital experience and improving brand value..</h4>
           ...
           <div className='webdev112'  >
               <img src='./images/serimg4.jpg' alt='logo1'></img>
           </div>
           </div>
